  ...
  return (
    <div className='group/feature text-foreground flex flex-col gap-4 p-4'>
      ...
      <div className='flex items-center self-start'>
        <div className='from-brand-highlight/20 to-brand-highlight/5 text-brand-dark ring-brand-highlight/25 group-hover/feature:ring-brand-highlight/45 dark:text-brand-highlight flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br shadow-inner ring-1 transition-all duration-300 group-hover/feature:scale-110'>
          {icon}
        </div>
      </div>
      {/* Title */}
